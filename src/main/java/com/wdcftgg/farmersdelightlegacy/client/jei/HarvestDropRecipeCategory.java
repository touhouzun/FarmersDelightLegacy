...
public final class HarvestDropRecipeCategory implements IRecipeCategory<HarvestDropJeiRecipe> {
    ...
    public HarvestDropRecipeCategory(IGuiHelper guiHelper) {
    ...
    public String getUid() {
        return JeiUids.harvestDrops;
    }

    @Override
    public String getTitle() {
        return I18n.format("farmersdelight.jei.harvest_drops");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, HarvestDropJeiRecipe recipeWrapper, IIngredients ingredients) {
